# -*- coding: utf-8 -*-
#
# git-flow documentation build configuration file, created by
# sphinx-quickstart on Tue Nov  2 13:23:54 2010.
#
...
exclude_patterns = ['_build', 'html', 'man', '_subcmd-*.rst', '_manpage-*.rst']
...
latex_documents = [
  ('index', 'git-flow.tex', u'git-flow Documentation',
   u'Vincent Driessen', 'manual'),
]
